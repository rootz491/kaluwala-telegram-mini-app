export const messages = {
  ...
  upload: {
    ...
    successAdmin:
      "✅ Image approved and uploaded to gallery! Your photo is now live.",
  ...
  moderation: {
    ...
    alreadyModerated: (status) =>
      `⚠️ Already ${status}. Cannot change decision.`,
